...
if __name__ == "__main__":
    ...
    for angle_of_attack in angles:
        ...
        for mach_infinity in machs:
            ...
            if mach_infinity > 0.75 or angle_of_attack > 2.0:
                upwind_factor_constant = 1.2
            else:
            ...
            plt.legend()
            plt.tight_layout()
            plt.savefig("Captures/Simulation_" + str(simulation_number) + "_A_" + str(angle_of_attack) + "_M_" + str(mach_infinity) + ".png")
            plt.close(fig)
