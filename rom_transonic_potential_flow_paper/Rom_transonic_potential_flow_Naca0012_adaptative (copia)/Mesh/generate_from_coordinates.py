...
FarField_MeshSize = Domain_Length / (50.0 * 1)
...
Upper_Airfoil = geompy.MakeCurveParametric("t", "0.6*(0.2969*sqrt(t) - 0.1260*t - 0.3516*t**2 + 0.2843*t**3 - 0.1036*t**4)", "0", 0, 1, 999, GEOM.Interpolation, True)
Lower_Airfoil = geompy.MakeCurveParametric("t", "-0.6*(0.2969*sqrt(t) - 0.1260*t - 0.3516*t**2 + 0.2843*t**3 - 0.1036*t**4)", "0", 0, 1, 999, GEOM.Interpolation, True)
...
Face_Airfoil = geompy.MakeTranslation(Face_Airfoil_Before, 0.0, 0, 0)
...
Fluid.ExportMED(f"model_mesh_0.med")
...
create_kratos_input_tui.CreateMdpaFile(meshes, f"model_mesh_0")
