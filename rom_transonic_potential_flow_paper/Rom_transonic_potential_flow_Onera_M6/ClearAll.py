...
def Clear():
    ...
    KratosMultiphysics.kratos_utilities.DeleteDirectoryIfExisting('HROM_Snapshots_from_HROM_model')
...
def ClearAll():
    ...
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('Onera_transonic_Test_HROM_1.post.lst')
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('upwind_elements_list.txt')
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('wake_angles.dat')
