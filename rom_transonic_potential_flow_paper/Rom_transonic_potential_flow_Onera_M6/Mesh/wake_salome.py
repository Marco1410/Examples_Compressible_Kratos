...
Wake_min_mesh_size      = 0.002
TE_Wing_mesh_size       = 0.002

onera_geometry_igs_path = "Mesh/onera_m6_geometry/Onera_M6_geometry.igs"

if not os.path.exists('WakeFiles'):
  os.mkdir('WakeFiles')
...
for Wake_angle in Wake_angles:
    ...
    Wake_output_name = f'WakeFiles/Wake_{Wake_angle}.stl'
