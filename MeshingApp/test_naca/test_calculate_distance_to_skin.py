...
def test_naca_0012_calculate_distance_to_skin_2d():
    ...
    KratosMultiphysics.ModelPartIO("test_calculate_distance_to_skin_naca_0012").ReadModelPart(skin_model_part)
    ...
    for i in range(iterations):
        ...
        KratosMultiphysics.CalculateDistanceToSkinProcess2D(model_part, skin_model_part, 1e-12).Execute()
...
def test_naca_0012_calculate_distance_to_skin_3d():
    ...
    # Set aerofoil geometry
    skin_model_part = current_model.CreateModelPart("Aerofoil")
    KratosMultiphysics.ModelPartIO("test_calculate_distance_to_skin_naca_0012_3d").ReadModelPart(skin_model_part)
...
if __name__ == '__main__':
    domain_size = 3
    if (domain_size == 2):
        test_naca_0012_calculate_distance_to_skin_2d()
    else:
        test_naca_0012_calculate_distance_to_skin_3d()
