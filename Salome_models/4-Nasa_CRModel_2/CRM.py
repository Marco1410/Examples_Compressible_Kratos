...
PlaneAngle = 0.0
########################
DomainHeight = 1000.0 #X
DomainWidth  = 500.0 #Y
DomainLength = 1000.0 #Z
########################
MeshGrowthRate = 0.2
########################
MeshMaxSize = 50.0
MeshMinSize = 0.5
########################
MeshPlaneMaxSize = 0.5
MeshPlaneMinSize = 0.5
########################
Wake_angle         = 2.31
...
Wake_output_name      = Dir + "/SalomeFiles/wake_sup.stl"
...
meshes = [
          ...
          create_kratos_input_tui.SalomeMesh(Plane_TE_Sup_1, mesh_description_surface, "TE_Wing"),
          create_kratos_input_tui.SalomeMesh(Plane_1, mesh_description_surface, "Wing"),
          ]
