                ...
                if parameters["output_processes"].Has("gid_output"):
                    ...
                    if 'HROM' in simulation_name:
                        ...
                        if (len(fom) != len(hrom)):
                            ...
                            delta_q_matrix = np.array(delta_q_matrix).T
...
def GetRomManagerParameters():
    general_rom_manager_parameters = KratosMultiphysics.Parameters("""{
            ...
            "HROM":{
                ...
                "include_elements_model_parts_list": ["MainModelPart.upwind_elements"],
...
if __name__ == "__main__":
    ...
    Plot_Cps(mu_train, 'Train_Captures', use_hrom_model_part)
    Plot_Cps(mu_test, 'Test_Captures', use_hrom_model_part)
