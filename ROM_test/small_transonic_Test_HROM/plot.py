...
# save parameters
#
def Plot_Cps(mu_list, capture_directory, use_hrom_model_part):
    ...
    for mu in mu_list:
        ...
        #### HROM ######
        if use_hrom_model_part:
            hrom_name = f'HROM_Snapshots_from_HROM_model/{case_name}.npy'
        else:
...
if __name__ == "__main__":
    ...
    Plot_Cps(mu_train, 'Train_Captures', False)
    Plot_Cps(mu_test, 'Test_Captures', False)