                ...
                if os.path.exists(f'FOM_Snapshots/{case_name}.npy'):
                    ...
                    if parameters["output_processes"].Has("vtk_output"):
                        ...
                        if 'FOM' in simulation_name:
                            ...
                            modelpart = self.model["FluidModelPart.Wing"]
...
def GetRomManagerParameters():
    general_rom_manager_parameters = KratosMultiphysics.Parameters("""{
            ...
            "rom_stages_to_test"  : ["HROM"],            // ["ROM","HROM"]
...
if __name__ == "__main__":
    ...
    # mu_train_list = random.sample(mu_train, 1)
    ...
    rom_manager.Test(mu_train + mu_test)
