...
for i,size in enumerate(airfoil_sizes):
  ...
  NETGEN_2D_Parameters_1.SetGrowthRate( MeshGrowthRate )
  ...
  #Set geometric mesh
  Geometric_Progression_1 = Regular_1D.GeometricProgression(Min_Airfoil_MeshSize,Ratio,[])
  ...
  smesh.SetName(Geometric_Progression_1, 'Geometric_Progression_1')
  ...
  Fluid.ExportMED(f"{Directory}/model_mesh_{i}.med")

  #Save salome files
  salome.myStudy.SaveAs(f"{Directory}/salome_model_{i}.hdf", study, False)
  ...
  create_kratos_input_tui.CreateMdpaFile(meshes, f"{Directory}/model_mesh_{i}")
