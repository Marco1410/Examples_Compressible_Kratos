        ...
        def Run(self):
            ...
            if self._GetSimulationName() == "Analysis": # FOM
                ...
                if parameters["output_processes"].Has("gid_output"):
                    ...
                    if (mach <= 0.73 and mach >= 0.70 and angle <= 1.00 and angle >= 0.00):
                        settings_number = "00"
                    if (mach <= 0.76 and mach > 0.73 and angle <= 1.00 and angle >= 0.00):
                        settings_number = "0"
                    if (mach <= 0.72 and mach >= 0.70 and angle <= 1.75 and angle >= 1.00):
                        settings_number = "1"
                    if (mach <= 0.74 and mach > 0.72 and angle <= 1.75 and angle >= 1.00):
                        settings_number = "2"
                    if (mach <= 0.76 and mach > 0.74 and angle <= 1.75 and angle >= 1.00):
                        settings_number = "3"
                    if (mach <= 0.72 and mach >= 0.70 and angle <= 2.50 and angle > 1.75):
                        settings_number = "4"
                    if (mach <= 0.74 and mach > 0.72 and angle <= 2.50 and angle > 1.75):
                        settings_number = "5"
                    if (mach > 0.74 and mach <= 0.76 and angle > 1.75):
                        if (angle <= 2.00):
                            settings_number = "6"
                        else:
                            settings_number = "7"
                
                    info_steps_list.append([settings_number,
                                            case_type,
                                            angle,
                                            mach, 
                    ...
                    if os.path.exists(f'FOM_data.xlsx'):
                        ...
                        hoja = wb.active
                        hoja.append(('Settings number', 'Case name', 'Angle [º]', 'Mach', 'NL iterations', 'Residual norm', 'Approximation error [%]', 'Modes', 'Time [sec]', 'Nodes', 'Cl', 'Cd'))
                        print('|   Settings number  |   Case name    |    Angle [º]    |    Mach     |   NL iterations    |   Residual norm    |    Approximation error [%]    |   Modes   |   Time [sec]   |  Nodes  |   Cl   |    Cd   |')
                        for item in info_steps_list:
                            hoja.append(item)
                            print(item)
                        wb.save(f'FOM_data.xlsx')
                ...
                if parameters["output_processes"].Has("gid_output"):
                    ...
                    if 'HROM' in simulation_name:                      # HROM
                        ...
                        if os.path.exists(f'case_data.xlsx'):
                            ...
                            print('|   Case name    |    Angle [º]    |    Mach     |   NL iterations    |   Residual norm    |    Approximation error [%]    |   Modes   |   Time [sec]   |  Nodes  |   Cl   |    Cd   |')
                            for item in info_steps_list:
                                hoja.append(item)
                                print(item)
                            wb.save(f'case_data.xlsx')
...
def UpdateProjectParameters(parameters, mu=None):
    ...
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     parameters["solver_settings"]["scheme_settings"]["initial_critical_mach"].SetDouble(0.91)
    ...
    # if (mach_infinity > 0.74 and mach_infinity <= 0.76 and angle_of_attack > 1.75 and angle_of_attack <= 2.00):
    #     # input("6")
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     print("6")
    ...
    # if (mach_infinity > 0.74 and mach_infinity <= 0.76 and angle_of_attack > 2.0 and angle_of_attack <= 2.50):
    #     # input("7")
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    #     print("7")
...
if __name__ == "__main__":
    ...
    if angle_range[0] <= 1.0 and angle_range[1]>= 2.0 and mach_range[0] <= 0.75 and mach_range[1]>=0.75:
    ...
    if os.path.exists('mu_train_updated.npy'):
        mu_train = np.load('mu_train_updated.npy')
        mu_train =  [mu.tolist() for mu in mu_train]
        mu_train_not_scaled = [mu_value for mu_value, mu_train_value in zip(mu_train_not_scaled, mu_train) if mu_train_value in mu_train]
        np.save('mu_train_not_scaled_updated',mu_train_not_scaled)
