...
for i,size in enumerate(airfoil_sizes):
  ...
  Fluid.ExportMED(f"model_mesh_{i}.med")

  #Save salome files
  salome.myStudy.SaveAs(f"salome_model_{i}.hdf", study, False)
  ...
  create_kratos_input_tui.CreateMdpaFile(meshes, f"model_mesh_{i}")
