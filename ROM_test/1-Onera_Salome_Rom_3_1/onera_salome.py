...
Dir                     = "/media/marco-kratos-pc/datos/Examples_Compressible_Kratos/1-Onera_Salome_Rom_3_1"
...
meshes = [
          ...
          create_kratos_input_tui.SalomeMesh(Wing_1, mesh_description_wall, "Wing"),
          ]
