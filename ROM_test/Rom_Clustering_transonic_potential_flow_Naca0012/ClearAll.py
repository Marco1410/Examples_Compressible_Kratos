...
def ClearAll():
    ...
    KratosMultiphysics.kratos_utilities.DeleteDirectoryIfExisting('Clustering_mu_run_plots')
    ...
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('Run_predicted_indexes_list.npy')
    ...
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('Rom_Clustering_transonic_potential_flow_Naca0012.post.lst')
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('upwind_elements_list.txt')
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('trailing_edge_element_id.txt')
