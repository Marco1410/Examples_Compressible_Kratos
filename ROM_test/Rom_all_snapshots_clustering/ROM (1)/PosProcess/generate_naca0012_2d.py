...
for i,size in enumerate(airfoil_sizes):
  ...
  Fluid.ExportMED("model_mesh_"+ str(i) +".med")

  #Save salome files
  salome.myStudy.SaveAs("salome_model_"+ str(i) +".hdf", study, False)
  ...
  create_kratos_input_tui.CreateMdpaFile(meshes, "model_mesh_"+ str(i))
