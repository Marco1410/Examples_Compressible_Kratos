...
def CleanFolder():
    ...
    KratosMultiphysics.kratos_utilities.DeleteFileIfExisting('naca0012_compressible_transonic_rom_potential_flow_2D (Nicolas).post.lst')
    os.mkdir("Results")
    os.mkdir("Data")
    os.mkdir("Captures")
    os.mkdir("Meshes")
...
if __name__ == "__main__":
    ...
    rom_manager.Fit(mu_train,store_all_snapshots=True, store_residuals_projected = True)
