...
from export_errors_to_gid import ExportErrors
    ...
    class CustomSimulation(cls):
        ...
        # def ModifyInitialProperties(self):
            ...
            if self._GetSimulationName() == "::[ROM Simulation]:: ":
                parameters["solver_settings"]["maximum_iterations"].SetInt(200)
        ...
        def FinalizeSolutionStep(self):
            ...
            # KratosMultiphysics.ModelPartIO("model_part", KratosMultiphysics.IO.WRITE | KratosMultiphysics.IO.MESH_ONLY).WriteModelPart(modelpart)
