...
class RomManager(object):
    ...
    def __LaunchTrainROM(self, mu_train):
        ...
        SnapshotsMatrix = []; SnapshotsMatrix_nc = []
        ...
        # SnapshotsMatrix_nc = np.load('DataBase/SnapshotsMatrix_not_conv.npy')

        phi_c,_,_,_= RandomizedSingularValueDecomposition().Calculate(SnapshotsMatrix, 1e-12)
