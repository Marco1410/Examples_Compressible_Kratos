...
// Project includes
#include "operations/potential_to_compressible_operation.h"
#include "utilities/parallel_utilities.h"

namespace Kratos
{

PotentialToCompressibleOperation::PotentialToCompressibleOperation(
    Model& rModel,
        ...
        : Modeler()
{
    ...
    KRATOS_ERROR_IF_NOT(mpModel == &rDestinationModelPart.GetModel()) << "PotentialToCompressibleOperation. The model parts belong to different models." << std::endl;
...
Modeler::Pointer PotentialToCompressibleOperation::Create(Model& rModel,
    const Parameters ModelParameters) const
{
    return Kratos::make_shared<PotentialToCompressibleOperation>(rModel, ModelParameters);
}

const Parameters PotentialToCompressibleOperation::GetDefaultParameters() const
{
...
void PotentialToCompressibleOperation::Execute()
{
...
void PotentialToCompressibleOperation::RecursivelyCopyProperties(
    ModelPart& rOriginModelPart,
    ModelPart& rDestinationModelPart)
{
...
void PotentialToCompressibleOperation::ReplaceProperties(
