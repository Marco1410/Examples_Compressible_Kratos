...
if __name__ == "__main__":
    ...
    for n,file in enumerate(files):
        ...
        if not os.path.exists(dir+"/Data/"+name+".dat") or not os.path.exists(dir+"/Data/full_"+name+".dat") or not os.path.exists(dir+"/Results/"+name):
            ...
            if fix_database:
                ...
                parameters["output_processes"]["vtk_output"][0]["Parameters"]["output_path"].SetString("DataBase/Results/"+ name)
