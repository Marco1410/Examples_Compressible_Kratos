...
salome_files_path = "/media/marco-kratos-pc/datos/Examples_Compressible_Kratos/RomManager PotentialFlow/branch_CompressiblePotentialFlow_(without_mesh_moving)(salome)/salome_files"
